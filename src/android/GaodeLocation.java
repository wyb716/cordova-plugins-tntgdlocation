...
public class GaodeLocation extends CordovaPlugin {
  ...
  public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
    if (action.equals("getCurrentPosition")) {
      if(needPermission(CODE_ACCESS_FINE_LOCATION)){
  ...
  private void getFineLocationPermission(CallbackContext callbackContext) {
    PermissionHelper.requestPermission(this, CODE_ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION);
  }

  private void getCoarseLocationPermission(CallbackContext callbackContext){
    PermissionHelper.requestPermission(this, CODE_ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION);
  }
  ...
  private boolean hasCoarseLocationPermission() {
    return PermissionHelper.hasPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION);
  }

  private boolean needPermission(int permissionType) throws JSONException {

    if(permissionType == CODE_ACCESS_FINE_LOCATION && hasFineLocationPermission()) {
      return false;
    }
    else if(permissionType == CODE_ACCESS_COARSE_LOCATION && hasCoarseLocationPermission()){
      return false;
    }
